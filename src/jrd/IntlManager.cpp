...
{
	{CS_NONE, CollId(0), "NONE", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_BINARY, CollId(0), "OCTETS", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ASCII, CollId(0), "ASCII", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_UNICODE_FSS, CollId(0), "UNICODE_FSS", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_UTF8, CollId(0), "UTF8", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_UTF8, CollId(1), "UCS_BASIC", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_UTF8, CollId(2), "UNICODE", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_UTF8, CollId(3), "UNICODE_CI", "UNICODE",
		TEXTTYPE_ATTR_PAD_SPACE | TEXTTYPE_ATTR_CASE_INSENSITIVE, NULL},
	{CS_UTF8, CollId(4), "UNICODE_CI_AI", "UNICODE",
		TEXTTYPE_ATTR_PAD_SPACE | TEXTTYPE_ATTR_CASE_INSENSITIVE | TEXTTYPE_ATTR_ACCENT_INSENSITIVE,
		NULL},
#ifdef FB_NEW_INTL_ALLOW_NOT_READY
	{CS_UTF16, CollId(0), "UTF16", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_UTF16, CollId(1), "UCS_BASIC", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	...
	{CS_DOS_437, CollId(1), "PDOX_ASCII", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_437, CollId(2), "PDOX_INTL", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_437, CollId(3), "PDOX_SWEDFIN", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_437, CollId(4), "DB_DEU437", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_437, CollId(5), "DB_ESP437", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_437, CollId(6), "DB_FIN437", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_437, CollId(7), "DB_FRA437", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_437, CollId(8), "DB_ITA437", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_437, CollId(9), "DB_NLD437", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_437, CollId(10), "DB_SVE437", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_437, CollId(11), "DB_UK437", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_437, CollId(12), "DB_US437", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_850, CollId(0), "DOS850", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_850, CollId(1), "DB_FRC850", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_850, CollId(2), "DB_DEU850", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_850, CollId(3), "DB_ESP850", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_850, CollId(4), "DB_FRA850", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_850, CollId(5), "DB_ITA850", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_850, CollId(6), "DB_NLD850", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_850, CollId(7), "DB_PTB850", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_850, CollId(8), "DB_SVE850", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_850, CollId(9), "DB_UK850", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_850, CollId(10), "DB_US850", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_865, CollId(0), "DOS865", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_865, CollId(1), "PDOX_NORDAN4", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_865, CollId(2), "DB_DAN865", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_865, CollId(3), "DB_NOR865", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ISO8859_1, CollId(0), "ISO8859_1", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ISO8859_1, CollId(1), "DA_DA", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ISO8859_1, CollId(2), "DU_NL", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ISO8859_1, CollId(3), "FI_FI", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ISO8859_1, CollId(4), "FR_FR", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ISO8859_1, CollId(5), "FR_CA", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ISO8859_1, CollId(6), "DE_DE", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ISO8859_1, CollId(7), "IS_IS", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ISO8859_1, CollId(8), "IT_IT", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ISO8859_1, CollId(9), "NO_NO", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ISO8859_1, CollId(10), "ES_ES", NULL, TEXTTYPE_ATTR_PAD_SPACE, "DISABLE-COMPRESSIONS=1;SPECIALS-FIRST=1"},
	{CS_ISO8859_1, CollId(11), "SV_SV", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ISO8859_1, CollId(12), "EN_UK", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ISO8859_1, CollId(14), "EN_US", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ISO8859_1, CollId(15), "PT_PT", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ISO8859_1, CollId(16), "PT_BR", NULL,
		TEXTTYPE_ATTR_PAD_SPACE | TEXTTYPE_ATTR_CASE_INSENSITIVE | TEXTTYPE_ATTR_ACCENT_INSENSITIVE,
		NULL},
	{CS_ISO8859_1, CollId(17), "ES_ES_CI_AI", NULL,
		TEXTTYPE_ATTR_PAD_SPACE | TEXTTYPE_ATTR_CASE_INSENSITIVE | TEXTTYPE_ATTR_ACCENT_INSENSITIVE,
	...
	{CS_ISO8859_1, CollId(19), "FR_CA_CI_AI", "FR_CA",
		TEXTTYPE_ATTR_PAD_SPACE | TEXTTYPE_ATTR_CASE_INSENSITIVE | TEXTTYPE_ATTR_ACCENT_INSENSITIVE,
		"SPECIALS-FIRST=1"},
	{CS_ISO8859_2, CollId(0), "ISO8859_2", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ISO8859_2, CollId(1), "CS_CZ", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ISO8859_2, CollId(2), "ISO_HUN", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ISO8859_2, CollId(3), "ISO_PLK", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ISO8859_3, CollId(0), "ISO8859_3", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ISO8859_4, CollId(0), "ISO8859_4", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ISO8859_5, CollId(0), "ISO8859_5", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ISO8859_6, CollId(0), "ISO8859_6", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ISO8859_7, CollId(0), "ISO8859_7", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ISO8859_8, CollId(0), "ISO8859_8", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ISO8859_9, CollId(0), "ISO8859_9", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ISO8859_13, CollId(0), "ISO8859_13", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_ISO8859_13, CollId(1), "LT_LT", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_852, CollId(0), "DOS852", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_852, CollId(1), "DB_CSY", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_852, CollId(2), "DB_PLK", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_852, CollId(4), "DB_SLO", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_852, CollId(5), "PDOX_CSY", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_852, CollId(6), "PDOX_PLK", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_852, CollId(7), "PDOX_HUN", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_852, CollId(8), "PDOX_SLO", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_857, CollId(0), "DOS857", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_857, CollId(1), "DB_TRK", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_860, CollId(0), "DOS860", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_860, CollId(1), "DB_PTG860", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_861, CollId(0), "DOS861", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_861, CollId(1), "PDOX_ISL", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_863, CollId(0), "DOS863", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_863, CollId(1), "DB_FRC863", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_CYRL, CollId(0), "CYRL", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_CYRL, CollId(1), "DB_RUS", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_CYRL, CollId(2), "PDOX_CYRL", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_737, CollId(0), "DOS737", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_775, CollId(0), "DOS775", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_858, CollId(0), "DOS858", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_862, CollId(0), "DOS862", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_864, CollId(0), "DOS864", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_866, CollId(0), "DOS866", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_DOS_869, CollId(0), "DOS869", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_WIN1250, CollId(0), "WIN1250", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_WIN1250, CollId(1), "PXW_CSY", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_WIN1250, CollId(2), "PXW_HUNDC", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_WIN1250, CollId(3), "PXW_PLK", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_WIN1250, CollId(4), "PXW_SLOV", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_WIN1250, CollId(5), "PXW_HUN", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_WIN1250, CollId(6), "BS_BA", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_WIN1250, CollId(7), "WIN_CZ", NULL, TEXTTYPE_ATTR_PAD_SPACE | TEXTTYPE_ATTR_CASE_INSENSITIVE, NULL},
	{CS_WIN1250, CollId(8), "WIN_CZ_CI_AI", NULL,
		TEXTTYPE_ATTR_PAD_SPACE | TEXTTYPE_ATTR_CASE_INSENSITIVE | TEXTTYPE_ATTR_ACCENT_INSENSITIVE,
		NULL},
	{CS_WIN1251, CollId(0), "WIN1251", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_WIN1251, CollId(1), "PXW_CYRL", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_WIN1251, CollId(2), "WIN1251_UA", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_WIN1252, CollId(0), "WIN1252", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_WIN1252, CollId(1), "PXW_INTL", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_WIN1252, CollId(2), "PXW_INTL850", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_WIN1252, CollId(3), "PXW_NORDAN4", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_WIN1252, CollId(4), "PXW_SPAN", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_WIN1252, CollId(5), "PXW_SWEDFIN", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_WIN1252, CollId(6), "WIN_PTBR", NULL,
		TEXTTYPE_ATTR_PAD_SPACE | TEXTTYPE_ATTR_CASE_INSENSITIVE | TEXTTYPE_ATTR_ACCENT_INSENSITIVE,
		NULL},
	{CS_WIN1253, CollId(0), "WIN1253", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_WIN1253, CollId(1), "PXW_GREEK", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_WIN1254, CollId(0), "WIN1254", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_WIN1254, CollId(1), "PXW_TURK", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_NEXT, CollId(0), "NEXT", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_NEXT, CollId(1), "NXT_US", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_NEXT, CollId(2), "NXT_DEU", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_NEXT, CollId(3), "NXT_FRA", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_NEXT, CollId(4), "NXT_ITA", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_NEXT, CollId(5), "NXT_ESP", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_WIN1255, CollId(0), "WIN1255", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_WIN1256, CollId(0), "WIN1256", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_WIN1257, CollId(0), "WIN1257", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_WIN1257, CollId(1), "WIN1257_EE", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_WIN1257, CollId(2), "WIN1257_LT", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_WIN1257, CollId(3), "WIN1257_LV", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_KSC5601, CollId(0), "KSC_5601", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_KSC5601, CollId(1), "KSC_DICTIONARY", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_BIG5, CollId(0), "BIG_5", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_GB2312, CollId(0), "GB_2312", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_KOI8R, CollId(0), "KOI8R", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
	{CS_KOI8R, CollId(1), "KOI8R_RU", NULL, TEXTTYPE_ATTR_PAD_SPACE, NULL},
